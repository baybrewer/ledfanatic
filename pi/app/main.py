...
def main():
  ...
  effect_catalog.register_imported('fluid_jets', EffectMeta(
    ...
    params=(
      {'name': 'gain', 'label': 'Gain', 'min': 0.5, 'max': 5.0, 'step': 0.1, 'default': 2.0, 'type': 'slider'},
      {'name': 'force', 'label': 'Jet Force', 'min': 5.0, 'max': 80.0, 'step': 2.0, 'default': 40.0, 'type': 'slider'},
  ...
  effect_catalog.register_imported('smoke_rings', EffectMeta(
    ...
    params=(
      ...
      {'name': 'strength', 'label': 'Strength', 'min': 50.0, 'max': 2000.0, 'step': 25.0, 'default': 600.0, 'type': 'slider'},
      ...
      {'name': 'trail', 'label': 'Trail', 'min': 0.9, 'max': 0.999, 'step': 0.001, 'default': 0.998, 'type': 'slider'},
    ),
  ))
