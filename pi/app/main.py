...
def main():
  ...
  effect_catalog.register_imported('smoke_rings', EffectMeta(
    ...
    params=(
      ...
      {'name': 'strength', 'label': 'Strength', 'min': 10.0, 'max': 200.0, 'step': 5.0, 'default': 80.0, 'type': 'slider'},
      ...
      {'name': 'trail', 'label': 'Trail', 'min': 0.8, 'max': 0.99, 'step': 0.01, 'default': 0.95, 'type': 'slider'},
    ),
  ))
